      ...
      <section className="bg-white py-20 px-5 md:px-8">
        <div className="max-w-6xl mx-auto">
              ...
              >
                ...
                <ul className="space-y-4 flex-grow">
                  ...
                  {state.cons?.map((con, idx) => (
                    <li key={`con-${idx}`} className="flex items-start gap-3">
                      <div className="mt-1 flex-shrink-0">
          ...
          <motion.p
            ...
            className="text-center text-[#6B7280] mt-8 text-sm italic"
          >
            {content.llcPage.otherStatesNote || 'Autres États sur demande.'}
          </motion.p>
        </div>
      </section>
